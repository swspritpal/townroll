...
<?php $__env->startSection('after-scripts'); ?>
  <?php echo Html::script(asset('js/jcrop/Jcrop.min.js')); ?>

  <?php echo Html::script(asset('js/vendor/select2.min.js')); ?>


  <?php echo Html::script(asset('js/post.js')); ?>
...
<?php echo Form::open(['class'=>'','id'=>'new_post_form','enctype' => 'multipart/form-data']); ?>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <?php echo e(Form::file('post_image', ['class' => 'hidden post_image_file_input','accept'=>"image/*" ])); ?>


        <?php echo e(Form::hidden('is_post_have_image','no', array('id' => 'is_post_have_image'))); ?>

        <?php echo e(Form::hidden('is_crop_post_image','no', array('id' => 'is_crop_post_image'))); ?>


        <?php echo e(Form::hidden('image_x','', array('id' => 'image_x'))); ?>

        <?php echo e(Form::hidden('image_y','', array('id' => 'image_y'))); ?>

        <?php echo e(Form::hidden('image_w','', array('id' => 'image_w'))); ?>

        <?php echo e(Form::hidden('image_h','', array('id' => 'image_h'))); ?>
        ...
        <div class="form-group">
          <textarea name="post_content" cols="60" rows="2" class="form-control"  id="post_content" placeholder="Write here anything..." ></textarea>
          
        </div>


        <div class="form-group">
          <?php echo e(Form::label('categories', 'Who can see this ?', array('class' => 'mylabel'))); ?>


          <?php echo e(Form::select('categories[]',$user_categories,
                $home_city_place,
