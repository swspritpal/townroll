              ...
              <a href="javascript:void(0);"  class='locate-me-popup' > 
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 paddingUnset seperatorGroup locateMeButton">
                  <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3  paddingUnset">
                    <img src="<?php echo e(asset('img/icons/locateMeNew.png')); ?>" class="imgCircle" />
                  </div>
                ...
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 paddingUnset  seperatorGroup">
                    <a href="<?php echo e(route('frontend.index', ['cat' =>$user_category->id ])); ?>" class="filter-posts <?php echo e(( (app('request')->has('cat') && app('request')->input('cat') == $user_category->id) ? 'place-active':'')); ?>" data-filter-by="cat" data-filter-id="<?php echo e($user_category->id); ?>">
                      <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3  paddingUnset">
                        <img src="<?php echo asset("img/goole_places_image/$user_category->place_image_path" ); ?>" class="imgCircle" />
                      </div>
                      <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 ">
                        <div class="groupTitle"><?php echo $user_category->name; ?></div>
                        <div class="groupPopulation text-muted" ><i class="fa fa-users" aria-hidden="true"></i> <?php echo e($user_category->users_count); ?> population </div>
                      </div>
                    </a>
