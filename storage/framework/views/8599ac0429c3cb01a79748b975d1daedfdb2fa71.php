<?php $__currentLoopData = $liked_users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php if(!empty($liked_users['0']->users_count)): ?>

  <?php 
    $more_users=(int) ($liked_users['0']->users_count - env('DEFAULT_HOME_PAGE_LIKED_USERS_LIMIT'));
   ?>
